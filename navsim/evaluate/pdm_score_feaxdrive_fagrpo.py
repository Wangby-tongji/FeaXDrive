"""FA-GRPO PDM score wrapper for FeaXDrive training reward.

This module routes FA-GRPO reward scoring to the explicit FeaXDrive
FA-GRPO scorer. Final evaluation should continue using navsim.evaluate.pdm_score.
"""
...
from navsim.planning.simulation.planner.pdm_planner.scoring.feaxdrive_fagrpo_scorer import PDMScorer
