...
from .feaxdrive_dit import LightningDiT
...
class ReCogDriveDiffusionPlanner(nn.Module):
    ...
    def _project_x0_norm(self, x0_norm: torch.Tensor) -> torch.Tensor:
        ...
        x0_denorm_proj = self.projector.project_dynamics(x0_denorm)
...
# ---------------------------------------------------------------------
# FeaXDrive public aliases.
# The source-compatible implementation keeps the original ReCogDrive class
# names internally. These aliases make the FeaXDrive agent import stable.
# ---------------------------------------------------------------------
FeaXDriveDiffusionPlannerConfig = ReCogDriveDiffusionPlannerConfig
FeaXDriveDiffusionPlanner = ReCogDriveDiffusionPlanner
