"""FA-GRPO PDM scorer for FeaXDrive training reward.

Do not use this scorer for final benchmark evaluation. Final eval must keep
``pdm_scorer.py`` and standard ``pdm_comfort_metrics.py``.
"""
...
from navsim.planning.simulation.planner.pdm_planner.scoring.feaxdrive_fagrpo_comfort_metrics import ego_is_comfortable
